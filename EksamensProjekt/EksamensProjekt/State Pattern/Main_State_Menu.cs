...
public class Main_State_Menu:I_State_Menu
    {
        ...
        {           
                ...
                Vector2 registrationTextPosition = new Vector2(menu.firstButton.Center.X - menu.font.MeasureString("Registration").Length() - 15, menu.firstButton.Center.Y - menu.font.MeasureString("Registration").Y / 2);
                Vector2 loginTextPosition = new Vector2(menu.secondButton.Center.X - menu.font.MeasureString("Login").Length() - 55, menu.secondButton.Center.Y - menu.font.MeasureString("Login").Y / 2);
                Vector2 thirdButtonTextPosition = new Vector2(menu.thirdButton.Center.X - menu.font.MeasureString("Quit").Length() - 50, menu.thirdButton.Center.Y - menu.font.MeasureString("Quit").Y / 2);
